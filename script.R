...
for (subject in participants) {
  ...
  df_subject$FirstLookDurationObjectOutTop <- "TODO"
  ...
  #     scope = startend_test_outcome,
  #     intra_scope_window = c(120, "end"),
  #     first_look_cutoff = round(median(gazeshifts$AOIOutcomePhase$top$latencies) + 3 * sd(gazeshifts$AOIOutcomePhase$top$latencies))
  #     )$first_look_durations$top
