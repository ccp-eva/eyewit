...
#'     column_name = "set1",
#'     aoilist = list(
#'       aoi1 = list(hit_name = "left",
#'         x_topleft = 60, y_topleft = 290, x_bottomright = 690, y_bottomright = 1130),
#'       aoi2 = list(hit_name = "right",
#'         x_topleft = 1225, y_topleft = 290, x_bottomright = 1855, y_bottomright = 1130),
#'       aoi3 = list(hit_name = "top",
#'         x_topleft = 790, y_topleft = 10, x_bottomright = 1130, y_bottomright = 350),
#'       aoi4 = list(hit_name = "bottom",
#'         x_topleft = 790, y_topleft = 730, x_bottomright = 1130, y_bottomright = 1070)
#'     )
#'   ),
#'
#'   aoiset2 = list(
#'     column_name = "set2",
#'     aoilist = list(
#'       aoi1 = list(hit_name = "top",
#'         x_topleft = 790, y_topleft = 10, x_bottomright = 1130, y_bottomright = 350),
#'       aoi2 = list(hit_name = "bottom",
#'         x_topleft = 790, y_topleft = 730, x_bottomright = 1130, y_bottomright = 1070)
#'     )
#'   )
#' )
